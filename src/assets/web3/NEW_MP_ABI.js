	...
	},
	{
		...
		"outputs": [
			...
			},
			{
				...
				"internalType": "struct DreamhubNFTMarketplace.Ask[]",
				"name": "askInfo",
				"type": "tuple[]"
			},
			{
	...
	},
	{
		...
		"outputs": [
			...
			},
			{
				"components": [
					{
						"internalType": "enum DreamhubNFTMarketplace.CollectionStatus",
						"name": "status",
						"type": "uint8"
					},
					{
				...
				"internalType": "struct DreamhubNFTMarketplace.Collection[]",
