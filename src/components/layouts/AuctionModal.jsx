...
import { auctionNft } from "../../module/action/user-task";
  ...
  const submitFunc = (e) => {
    ...
    if (getCurrentProvider()?.networkVersion !== CHAIN_ID) {
      ...
      props.auctionNft(
        ...
        false,
        alert,
        "Your NFT has been placed on auction.",
        props.onHide
      );
    }
      ...
      <Modal show={props.show} onHide={props.onHide}>
        ...
        /> */}
          ...
          <p className="text-right price color-popup"> 4.89 ETH </p>
            ...
            >
              {props.auctionNftLoader ? <Spinner /> : `Bid `}
            </button>
          </div>
        </form>
      </Modal>
...
const mapStateToProps = (state) => ({
  auctionNftLoader: state.wallet.auctionNftLoader,
});
...
export default connect(mapStateToProps, mapDispatchToProps)(AuctionModal);
